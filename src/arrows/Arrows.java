...
public class Arrows extends GameEngine {
	...
	public GameObject getGame(int gameID) {
		switch (gameID) {
			...
			case 2: return new GameOver(this);
		}
		return null;
	}
 ...
 * 			COOL / WALA NA SA BEAT PERO PASOK PARIN
 * 			BAD / SOBRANG SABIT LANG
 * -PROPER SCORING (SEE getScore() FUNCTION ON GameFrame.java)
 * 		EX. 1000 = PERFECT / WOW! EXACT MUCH
 * 			700 = GREAT / MEDJO OFF BEAT LANG
 * 			500 = COOL / WALA NA SA BEAT PERO PASOK PARIN
 * 			100 = BAD / SOBRANG SABIT LANG
 * -DISPLAY THE SCORE
 * -MUSIC AND RIGHT SPEED OR TEMPO OF THE BUFFER
